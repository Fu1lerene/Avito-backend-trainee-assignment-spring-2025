...
// PostDummyLoginJSONBody defines parameters for DummyLogin.
type PostDummyLoginJSONBody struct {
	Role PostDummyLoginJSONBodyRole `json:"role"`
}

// PostDummyLoginJSONBodyRole defines parameters for DummyLogin.
...
// PostDummyLoginJSONRequestBody defines body for DummyLogin for application/json ContentType.
